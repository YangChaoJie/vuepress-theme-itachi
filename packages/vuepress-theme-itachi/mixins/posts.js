import { filterPosts, sortPostsByStickyAndDate, sortPostsByDate } from '../helpers/utils.js'

export default {
  computed: {
    $recoPosts () {
      // console.log('pages this.--------', this)
      // const {
      //   $categories: { ages: articles }
      // } = this
      ...
      const posts = filterPosts(this.$site.pages, false)
