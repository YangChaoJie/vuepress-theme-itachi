<template>
  <div class="buttons">
    <transition name="fade">
      <div
        title="返回顶部"
        class="button blur go-to-top iconfont iconvcom-top"
        v-show="showToTop"
        @click="scrollToTop"
      />
    </transition>
    <div
      title="去评论"
      class="button blur go-to-comment iconfont iconvcom-comment"
      v-show="showCommentBut"
      @click="scrollToComment"
    />
    <div
      title="主题模式"
      class="button blur theme-mode-but iconfont iconvcom-skin"
...
export default {
  ...
  mounted () {
    ...
    this.$nextTick(()=> {
      // console.log('document----', document.querySelector(this.COMMENT_SELECTOR_2));
      // this.getCommentTop()
