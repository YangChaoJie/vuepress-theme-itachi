<template>
  <div class="vcom-loading">
    <div class="vcom-loading-main">
      <div v-for="item in 4" :key-="`out${item}`"></div>
    </div>
    <div class="vcom-loading-title" v-if="frontmatter.home">{{site.title}}</div>
    <p class="vcom-loading-description" v-if="frontmatter.home">{{site.description}}</p>
  </div>
</template>
